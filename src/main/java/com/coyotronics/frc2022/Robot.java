...
public class Robot extends TimedRobot {
  ...
  static UsbCamera camIntake;
  static UsbCamera camField;
  /**
  ...
  public void robotInit() {
    ...
    // camIntake =  CameraServer.startAutomaticCapture(0);
    // camField = CameraServer.startAutomaticCapture(1);

    // camIntake.setResolution(10, 10);
    // camIntake.setFPS(10);
// 
    // camField.setResolution(10, 10);
    // camField.setFPS(10);
    ...
    // CameraServer.getServer().setSource();
  }
